define(['backbone'],function(Backbone){
    ...
    var ViewResource = Backbone.Model.extend({
        ...
        getParsedResourcePath: function(forcedDir){
            ...
            if(this.parsedResourcePath && forcedDir == undefined){ return this.parsedResourcePath; }
            else { this.parsedResourcePath = App.config.directories.parseTemplatePaths(this.get('resourcePath'), forcedDir); }
    ...
    var AppResources = Backbone.Collection.extend({
        ...
        getData: function(classID){
            var result = this.findWhere({classID:classID});
            if(result){ return result.get('data'); }
            return null;
        },
        ...
        getParsedResourcePath: function(classID, forcedDir){
            var result = this.findWhere({classID:classID});
            if(result){ return result.getParsedResourcePath(forcedDir); }
            return null;
        },
	...
	var MonsterParts = Backbone.Collection.extend({
        ...
        getByTypeAndCat: function(monsterType, category, hasFur, ignoreFur){
            ...
            //hasFur = (hasFur == undefined) ? false : (hasFur != '');
            //ignoreFur = (ignoreFur == undefined) ? false : (ignoreFur != '');

            if(ignoreFur){ result = self.where({monsterType:monsterType, category:category}); }
            else { result = self.where({monsterType:monsterType, category:category, fur:hasFur, universal:false}); }
            ...
            for(var i=0; i<universal.length; i++){
                ...
                if(!found){ result.push(universal[i]); }
            }

            return result;
        },

        getByTypeCatAndSubCat: function(monsterType, category, subCategory, hasFur, ignoreFur){
            ...
            if(ignoreFur){ results = self.where({monsterType:monsterType, category:category, subCategory:subCategory, universal:false}); }
            else { results = self.where({monsterType:monsterType, category:category, subCategory:subCategory, fur:hasFur, universal:false}); }
            ...
            for(var i=0; i<universal.length; i++){
                ...
                if(!found){ results.push(universal[i]); }
            }
	 ...
	 App.resources.monsterParts = new MonsterParts([
		...
		{classID: "Type1Color1", resourcePath: "images/monsters/type1/skin/colors/body_col_1.png", thumbnailPath: "images/monsters/type1/thumbnails/skin/colors/body_col_1.png", monsterType:1, category: "color", linkedIDs:['Type1Fur1'], zIndex:1, default:true},
        {classID: "Type1Color2", resourcePath: "images/monsters/type1/skin/colors/body_col_2.png", thumbnailPath: "images/monsters/type1/thumbnails/skin/colors/body_col_2.png", monsterType:1, category: "color", linkedIDs:['Type1Fur2'], zIndex:1},
        {classID: "Type1Color3", resourcePath: "images/monsters/type1/skin/colors/body_col_3.png", thumbnailPath: "images/monsters/type1/thumbnails/skin/colors/body_col_3.png", monsterType:1, category: "color", linkedIDs:['Type1Fur3'], zIndex:1},
        {classID: "Type1Color4", resourcePath: "images/monsters/type1/skin/colors/body_col_4.png", thumbnailPath: "images/monsters/type1/thumbnails/skin/colors/body_col_4.png", monsterType:1, category: "color", linkedIDs:['Type1Fur4'], zIndex:1},
        {classID: "Type1Color5", resourcePath: "images/monsters/type1/skin/colors/body_col_5.png", thumbnailPath: "images/monsters/type1/thumbnails/skin/colors/body_col_5.png", monsterType:1, category: "color", linkedIDs:['Type1Fur5'], zIndex:1},
         ...
         //type 2
		{classID: "Type2Color1", resourcePath: "images/monsters/type2/skin/colors/body_col_1.png", thumbnailPath: "images/monsters/type2/thumbnails/skin/colors/body_col_1.png", monsterType:2, category: "color", linkedIDs:['Type2Fur2'], zIndex:1, default:true},
        {classID: "Type2Color2", resourcePath: "images/monsters/type2/skin/colors/body_col_2.png", thumbnailPath: "images/monsters/type2/thumbnails/skin/colors/body_col_2.png", monsterType:2, category: "color", linkedIDs:['Type2Fur2'], zIndex:1},
        {classID: "Type2Color3", resourcePath: "images/monsters/type2/skin/colors/body_col_3.png", thumbnailPath: "images/monsters/type2/thumbnails/skin/colors/body_col_3.png", monsterType:2, category: "color", linkedIDs:['Type2Fur2'], zIndex:1},
        {classID: "Type2Color4", resourcePath: "images/monsters/type2/skin/colors/body_col_4.png", thumbnailPath: "images/monsters/type2/thumbnails/skin/colors/body_col_4.png", monsterType:2, category: "color", linkedIDs:['Type2Fur2'], zIndex:1},
        {classID: "Type2Color5", resourcePath: "images/monsters/type2/skin/colors/body_col_5.png", thumbnailPath: "images/monsters/type2/thumbnails/skin/colors/body_col_5.png", monsterType:2, category: "color", linkedIDs:['Type2Fur2'], zIndex:1},
        ...
        {classID: "Type3Color5", resourcePath: "images/monsters/type3/skin/colors/body_col_5.png", thumbnailPath: "images/monsters/type3/thumbnails/skin/colors/body_col_5.png", monsterType:3, category: "color", linkedIDs:['Type1Fur3'], zIndex:1, default:false},
         ...
         //type 4
		//{classID: "Type4Color1", resourcePath: "images/monsters/type4/skin/colors/body_col_1.png", thumbnailPath: "images/monsters/type1/thumbnails/skin/colors/body_col_4.png", monsterType:4, category: "color", linkedIDs:['Type1Fur4'], zIndex:1, default:true},
		//type 5
		//{classID: "Type5Color1", resourcePath: "images/monsters/type5/skin/colors/body_col_1.png", thumbnailPath: "images/monsters/type1/thumbnails/skin/colors/body_col_5.png", monsterType:5, category: "color", linkedIDs:['Type1Fur5'], zIndex:1, default:true}
	]);
